...
samples = {
  "Pileup0t20": {
         ...
         "fillcolor": ROOT.kRed,
         "isSig"    : True, 
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL16APV_simple"),
         "extraWeights": lambda x: (x["injected_PU"] >= 0)*(x["injected_PU"] < 20)*(x["injected_PU"] < 10)*x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*x["TrigSF"],
  },
  "Pileup20t40": {
