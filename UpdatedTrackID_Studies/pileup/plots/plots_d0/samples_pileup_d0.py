...
samples = {
  "Pileup0t10": {
         ...
         "fillcolor": ROOT.kRed,
         "isSig"    : True, 
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL16_d0")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL16APV_d0")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL17_d0")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL18_d0"),
