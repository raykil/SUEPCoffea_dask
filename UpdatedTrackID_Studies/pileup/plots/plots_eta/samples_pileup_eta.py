...
samples = {
  "Pileup0t20": {
         ...
         "fillcolor": ROOT.kRed,
         "isSig"    : True, 
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL16_eta")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL16APV_eta")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL17_eta")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL18_eta"),
