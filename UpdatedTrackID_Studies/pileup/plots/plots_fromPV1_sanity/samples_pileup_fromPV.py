...
samples = {
  "Pileup0t20": {
         ...
         "xsec"     : 870 * 0.0336 * 2, # in fbcd
         "linecolor": ROOT.kRed,
         "fillcolor": ROOT.kRed,
         "isSig"    : True, 
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL16_fromPV1_sanity")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL16APV_fromPV1_sanity")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL17_fromPV1_sanity")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup/UL18_fromPV1_sanity"),
