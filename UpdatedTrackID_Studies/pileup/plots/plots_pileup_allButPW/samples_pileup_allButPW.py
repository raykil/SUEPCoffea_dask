...
samples = {
  "Pileup0t20": {
         ...
         "fillcolor": ROOT.kRed,
         "isSig"    : True, 
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup_analysisLevel/UL16_allButPW")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup_analysisLevel/UL16APV_allButPW")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup_analysisLevel/UL17_allButPW")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup_analysisLevel/UL18_allButPW"),
  ...
  "Pileup40t60": {
         "name"     : "Pileup40to60", #Here plain text
