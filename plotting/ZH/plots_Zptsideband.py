...
plots = {
  "2D_Zpt_Zeta" : {
             "name"     : "2D_Zpt_Zeta",
             "bins"     : ["2Duniform", 100, 0, 500, 10, -5, 5],
             "channel"  : "onecluster",
             "value"    : lambda x, y : (x["Z_pt"], x["Z_eta"], y*cut(x)),
             "logY"     : True,
             "normalize": False,
             "maxY"     : 1e9,
             "minY"     : 1e0,
  ...
  "HT": {
             ...
             "channel"  : "onecluster",
             "value"    : lambda x, y : (x["leadjet_pt"]+x["subleadjet_pt"]+x["trailjet_pt"], y*cut(x)),
             "logY"     : True,
             "normalize": False,
             "maxY"     : 1e9,
             "minY"     : 1e0,
  ...
  "LHT":{
             ...
             "channel"  : "onecluster",
             "value"    : lambda x, y : (x["leadjet_pt"]+x["subleadjet_pt"]+x["trailjet_pt"]+x["leadlep_pt"] + x["subleadlep_pt"], y*cut(x)),
             "logY"     : True,
             "normalize": False,
             "maxY"     : 1e9,
             "minY"     : 1e0,
