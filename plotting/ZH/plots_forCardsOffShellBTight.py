...
plots = {
 ...
 "njets": {
  ...
  "leadjet_qgl": {
             ...
             "bins"     : ["uniform", 50, 0, 1],
             "channel"  : "onecluster",
             "value"    : lambda x, y : (x["leadjet_qgl"], y*cut(x)),
             "logY"     : True,
             "normalize": False,
             "maxY"     : 5e12,
             "minY"     : 1e0,
  ...
  "subleadjet_qgl": {
             ...
             "bins"     : ["uniform", 50, 0, 1],
             "channel"  : "onecluster",
             "value"    : lambda x, y : (x["subleadjet_qgl"], y*cut(x)),
             "logY"     : True,
             "normalize": False,
             "maxY"     : 5e12,
             "minY"     : 1e0,
  ...
  "trailjet_qgl": {
             ...
             "bins"     : ["uniform", 50, 0, 1],
             "channel"  : "onecluster",
             "value"    : lambda x, y : (x["trailjet_qgl"], y*cut(x)),
             "logY"     : True,
             "normalize": False,
             "maxY"     : 5e12,
             "minY"     : 1e0,
