...
samples = {
  "SUEP_generic_mS125_mD2.00_T2.00": {
         ...
         "isSig"    : False,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testJetID17/","/eos/cms/store/group/phys_exotica/SUEPs/UL17/hdf5_ANv4/"),
  ...
  "SUEP_generic_mS125_mD2.00_T2.00_withIP": {
         ...
         "fillcolor": ROOT.kRed,
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/cms/store/group/phys_exotica/SUEPs/UL17/hdf5_ANv4/", "/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testJetID17/"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*x["TrigSF"]*x["LepSF"],
  },
}
