...
samples = {
  ...
  "background": {
         ...
         "files"      : hdf5inpath(main_path + "ZG/"), # Just whatever so it reads quickly, we are not using it anywhere
         "th1": {"":"total_background_fitb","Up":"total_background_fitbUp","Dn":"total_background_fitbDn"},
  },      
  "SUEP_ZH_generic": {
         "name"     : "SUEP_ZH_generic", #Here plain text
         "label"    : "ZS^{gen}, m_{S} = 125 GeV (post-fit)", #Here we can use weird glyphs
         ...
         "th1": {"":"SUEP_hadronic_mS125_mD3.00_T3.00_fitb","Up":"SUEP_hadronic_mS125_mD3.00_T3.00_fitbUp","Dn":"SUEP_hadronic_mS125_mD3.00_T3.00_fitbDn"},
  }
