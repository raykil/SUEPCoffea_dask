...
samples = {
  "Pileup0t20": {
         ...
         "fillcolor": ROOT.kRed,
         "isSig"    : True, 
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup_analysisLevel/UL16_all")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup_analysisLevel/UL16APV_all")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup_analysisLevel/UL17_all")+hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/trackID/pileup_analysisLevel/UL18_all"),
