...
samples = {
  "SUEP_ZH_generic_nominal": {
         ...
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
  ...
  "SUEP_ZH_generic_ElSFUp": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15, 2),
  },
  ...
  "SUEP_ZH_generic_MuSFUp": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15, 1),
  },
  ...
  "SUEP_ZH_generic_PUUp": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight_Up"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_PUDn": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight_Dn"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_L1Up": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight_Up"]*x["bTagWeight"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_L1Dn": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight_Dn"]*x["bTagWeight"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_HFCorrUp": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight_HFCorr_Up"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_HFCorrDn": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight_HFCorr_Dn"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_LFCorrUp": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight_LFCorr_Up"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_LFCorrDn": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight_LFCorr_Dn"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_HFUnCorrUp": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight_HFUnCorr_Up"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_HFUnCorrDn": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight_HFUnCorr_Dn"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_LFUnCorrUp": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight_LFUnCorr_Up"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_LFUnCorrDn": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight_LFUnCorr_Dn"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_ISRUp": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["ISRWeight_Up"]*x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_ISRDn": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["ISRWeight_Dn"]*x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_FSRUp": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["FSRWeight_Up"]*x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15),
  },
  ...
  "SUEP_ZH_generic_FSRDn": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/home-c/cericeci/SUEP/SUEPCoffea_dask/testSignalSyst_UL16APV"),
         "extraWeights": lambda x: x["FSRWeight_Dn"]*x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15),
  },
