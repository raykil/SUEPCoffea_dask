...
samples = {  
  "GenericSignal_SFs": {
         ...
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/test/2015_Analyzed/"),
  },
    "GenericSignal_SFs_UP": {
         ...
         "isSig"    : True,
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*(x["TrigSF"]+x["TrigSF_Up"]+x["METTrig_Up"])*SF(x,15),
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/test/2015_Analyzed/"),
  },
      "GenericSignal_SFs_DOWN": {
         ...
         "linecolor": ROOT.kRed,
         "isSig"    : True,
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*(x["TrigSF"]-x["TrigSF_Dn"]-x["METTrig_Dn"])*SF(x,15),
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/test/2015_Analyzed/"),
  },
}
