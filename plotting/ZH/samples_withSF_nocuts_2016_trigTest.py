...
samples = {  
  "GenericSignal_SFs": {
         ...
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/testWorkflow/SUEP_Signal_m2T2_UL16/"),
  },
    "GenericSignal_SFs_UP": {
         ...
         "isSig"    : True,
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*(x["TrigSF"]+x["TrigSF_Up"])*SF(x,16),
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/testWorkflow/SUEP_Signal_m2T2_UL16/"),
  },
      "GenericSignal_SFs_DOWN": {
         ...
         "linecolor": ROOT.kRed,
         "isSig"    : True,
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*(x["TrigSF"]-x["TrigSF_Dn"])*SF(x,16),
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/testWorkflow/SUEP_Signal_m2T2_UL16/"),
  },
}
