...
main_path = "/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/hdf5_withsysts/"#"/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/hdf5/"
samples = {
  "data": {
         "name" : "data",
         "label": "Data",
  ...
  "DY_Pt0": {
         ...
         "fillcolor"  : 7, # White
         "isSig"      : False,
         "extraWeights": lambda x: 1*(x["genZpt"]==0.0)*x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15) , 
...
#  },
  ...
  "SUEP_ZH_generic_new": {
         ...
         "fillcolor": ROOT.kRed,
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/hdf5_withsysts/SUEP_generic_new_mS125_mD2_T2/"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15),
  },
  "SUEP_ZH_leptonic": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/hdf5_withsysts/SUEP_leptonic_mS125_mD2_T2/"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*SF(x,15),
  },
  "SUEP_ZH_hadronic": {
