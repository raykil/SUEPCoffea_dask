...
main_path = "/eos/cms/store/user/cericeci/SUEPS/UL16APV/hdf5/"#"/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/hdf5/"
samples = {
  "data": {
         "name" : "data",
         "label": "Data",
         ...
         "isSig"    : False,
         "files"    : hdf5inpath("/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/hdf5/data/"),#+ hdf5inpath(main_path + "data_RunB/")+hdf5inpath(main_path + "data_RunC/")+hdf5inpath(main_path + "data_RunD/"),
         "markerstyle": 20,
         "markersize" : 1,
  },
  "DY_Pt0": {
         ...
         "fillcolor"  : 7, # White
         "isSig"      : False,
         "extraWeights": lambda x: 1*(x["genZpt"]==0.0)*x["bTagWeight"]*SF(x,15) , 
  ...
  "DY_Pt0To50": {
         ...
         "isSig"    : False,
         "extraWeights": lambda x: x["bTagWeight"]*SF(x,15),
  ...
  "SUEP_ZH_generic_new": {
         ...
         "fillcolor": ROOT.kRed,
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/hdf5/SUEP_generic_new_mS125_mD2_T2/"),
         "extraWeights": lambda x: x["bTagWeight"]*SF(x,15),
  },
  "SUEP_ZH_leptonic": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/hdf5/SUEP_leptonic_mS125_mD2_T2/"),
         "extraWeights": lambda x: x["bTagWeight"]*SF(x,15),
  },
  "SUEP_ZH_hadronic": {
         ...
         "isSig"    : True,
         "files"    : hdf5inpath("/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/hdf5/SUEP_hadronic_mS125_mD2_T2/"),
         "extraWeights": lambda x: x["bTagWeight"]*SF(x,15),
  },
}
