...
main_path = "/eos/user/c/cericeci/SUEP/SUEPCoffea_dask/plotting/ZH/../../hdf5_withnmu/UL16/"
main_path_signal = "/eos/user/c/cericeci/SUEP/SUEPCoffea_dask/plotting/ZH/../../hdf5_withnmu/UL16/"
samples = {
  "data": {
         "name" : "data",
         "label": "Data",
         ...
         "isSig"    : False,
         "files"    : hdf5inpath(main_path + "data/"),
         "markerstyle": 20,
         "markersize" : 1,
  },
  "DY_Pt0": {
