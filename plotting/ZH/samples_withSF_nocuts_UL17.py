...
main_path = "/eos/cms/store/group/phys_exotica/SUEPs/UL17/hdf5/"
samples = {
  "data": {
         "name" : "data",
         "label": "Data",
  ...
  "DY_Pt0": {
         ...
         "fillcolor"  : 7, # White
         "isSig"      : False,
         "extraWeights": lambda x: 1*(x["genZpt"]==0.0)*x["bTagWeight"]*SF(x,17) , 
  ...
  "DY_Pt0To50": {
         ...
         "isSig"    : False,
         "extraWeights": lambda x: x["bTagWeight"]*SF(x,17),
