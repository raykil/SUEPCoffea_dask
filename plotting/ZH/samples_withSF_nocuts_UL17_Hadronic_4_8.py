...
main_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/HDF5s/2017/"
main_path_signal = "/eos/user/g/gdecastr/SUEPCoffea_dask/HDF5s/2017/"
...
#  },
  ...
  "SUEP_hadronic_mS125_mD4.00_T8.00": {
         ...
         "isSig"    : True,
         "doPlot"   : True,
         "files"    : hdf5inpath("/eos/user/g/gdecastr/SUEPCoffea_dask/HDF5s/Hadronic_4_8/2017/HDF5s/"),
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*x["TrigSF"]*x["LepSF"],
  },
