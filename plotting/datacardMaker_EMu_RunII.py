...
class datacardMaker(object):
  ...
  def collectYieldsPerBin(self):
    ...
    if self.options.blind_withS:
      ...
      print(self.channel)
      if self.channel == 'SR':
        signal = self.tf.Get("leadclustertracks_SR_SUEP_hadronic_mS125_mD5.00_T5.00")
      else:
        signal = self.tf.Get("leadclustertracks_" + self.channel + "_SUEP_hadronic_mS125_mD5.00_T5.00")
