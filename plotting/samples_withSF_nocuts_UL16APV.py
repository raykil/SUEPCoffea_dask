...
main_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/investigatingExcess/Control_15/"
samples = {
  "data": {
         "name" : "data",
         "label": "Data",
  ...
  #       "files"      : hdf5inpath(main_path + "DY_nano_Autumn16APV/"),
  #},      
  "DY_Pt0To50": {
  ...
  "ttto1l": {
         ...
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*x["TrigSF"]*x["LepSF"],
         "skim"     : "/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/skim_2l_20_10/TTTo1L1Nu2Q/skims.root",
  },
#  "Wjets": {
...
#         "skim"     : "/eos/cms/store/group/phys_exotica/SUEPs/UL16APV/skim_2l_20_10/VHnonbb/skims.root"
#  },
