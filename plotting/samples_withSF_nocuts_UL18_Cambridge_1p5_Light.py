...
main_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/differentRadii/Cambridge_1p5_Light/"
samples = {
  "DY_Pt0": {
...
#  },
  ...
  "WG": {
         ...
         "extraWeights": lambda x: x["PUWeight"]*x["L1prefireWeight"]*x["bTagWeight"]*x["TrigSF"]*x["LepSF"],
         "skim"     : "/eos/cms/store/group/phys_exotica/SUEPs/UL18/skim_2l_20_10/WG/skims.root"
  },
  "ttZll": {
