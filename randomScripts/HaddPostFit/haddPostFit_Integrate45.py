...
channels = ["E2", "E1","B2_B2bin1","B2_B2bin2","B2_B2bin3","B2_B2bin4","B2_B2bin5","B2_B2bin6","D2","D1","B1_B1bin1","B1_B1bin2","B1_B1bin3","B1_B1bin4","B1_B1bin5","B1_B1bin6","C2","C1","SR_SRbin1","SR_SRbin2","SR_SRbin3","SR_SRbin4","SR_SRbin5","SR_SRbin6"]
nc = len(channels)
processes = ["total_background","SUEP_hadronic_mS125_mD8.00_T12.00", "data"]
