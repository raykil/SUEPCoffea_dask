...
if __name__ == "__main__":
    root_directory = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate40/Comparing"

    output_file_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate40/Comparing/ClosureSFs_DataUncs.txt"
