...
if __name__ == "__main__":
    ...
    closureShapes_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate40/Comparing/ClosureSFs.txt"
    closureShapesUncs_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate40/Comparing/ClosureSFs_Uncs.txt"
    Normalization_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate40/Comparing/Normalization.txt"
    NormalizationUncs_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate40/Comparing/Normalization.txt"
