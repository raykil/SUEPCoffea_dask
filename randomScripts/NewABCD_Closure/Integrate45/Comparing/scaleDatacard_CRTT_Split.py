...
def modify_script(input_file, output_file, closureShapes_f, closureShapeUncs_f, Normalization_f, NormalizationUncs_f, year):
    ...
    pattern_BackNorm = r"rCRTT(?:16APV|16|17|18)\s*rateParam"
...
if __name__ == "__main__":
    ...
    closureShapes_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate45/Comparing/ClosureSFs.txt"
    closureShapesUncs_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate45/Comparing/ClosureSFs_Uncs.txt"
    Normalization_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate45/Comparing/Normalization.txt"
    NormalizationUncs_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate45/Comparing/Normalization.txt"
