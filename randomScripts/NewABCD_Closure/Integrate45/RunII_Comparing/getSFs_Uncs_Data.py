...
if __name__ == "__main__":
    root_directory = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate45/RunII_Comparing"

    output_file_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures_Integrate45/RunII_Comparing/ClosureSFs_DataUncs.txt"
