...
def calculate_ratios(input_file_path):
    ...
    bin_edges = [21, 26, 31, 36, 41, 46, 51, 56]
...
if __name__ == "__main__":
    root_directory = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures/RunII_Comparing"

    output_file_path = "/eos/user/g/gdecastr/SUEPCoffea_dask/CommonClosures/RunII_Comparing/ClosureSFs_DataUncs.txt"
