...
def plot_likelihood_scan(root_filename):
    ...
    for param in tracked_params:       
        ...
        cleaned_param_branch = param.replace("trackedParam_", "").replace("SUEP_hadronic_mS125_mD5.00_T5.00", "")
        if 'r2018' in cleaned_param_branch or 'r2017' in cleaned_param_branch or 'r2016' in cleaned_param_branch or 'r2016APV' in cleaned_param_branch:
        ...
        plt.savefig('/eos/user/g/gdecastr/www/Plots/SR_Blind_HighStats_55/'+param+'.png')
        plt.clf()


plot_likelihood_scan("/eos/user/g/gdecastr/SUEPCoffea_dask/Cards/Blind/HighStats/RunII/higgsCombine55_SR_Scan.MultiDimFit.mH120.root")