...
iJ = 0
allFiles = os.listdir("RunII_CRDY")

for f in os.listdir("RunII_CRDY"):
  if not("CombinedSRDY_" in f): continue
  ...
  fil.write("cmsenv\n")
  fil.write("cd /eos/user/g/gdecastr/SUEPCoffea_dask/Cards/HighStats/RunII_CRDY/\n")
